''' Self Normalizing Neural Network (SNN)
    for Fashion MNIST dataset. Using SELU activations with 
...
FIG = plt.gcf()
FIG.savefig('../bin/snn_fashion_mnist_2_hidden_accuracy.png')
plt.show()
...
FIG = plt.gcf()
FIG.savefig('../bin/snn_fashion_mnist_2_hidden_loss.png')
plt.show()
